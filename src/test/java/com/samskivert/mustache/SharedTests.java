...
public abstract class SharedTests extends TestCase {
    ...
    @Test
    public void testPrimitiveArrayIndexVariable() {
        test("1", "{{foo.0}}", context("foo", new int[]{1, 2, 3, 4}));
    }

    @Test
    public void testPrimitiveArrayIndexOutOfBoundsVariable() {
    ...
    @Test
    public void testListIndexSection() {
        test("baz", "{{#foo.0}}{{bar}}{{/foo.0}}", context(
                "foo", Arrays.asList(context("bar", "baz"), context("bar", "bif"))));
    }

    @Test
    public void testListIndexOutOfBoundsSection() {
        test("", "{{#foo.2}}{{bar}}{{/foo.2}}", context(
                "foo", Arrays.asList(context("bar", "baz"), context("bar", "bif"))));
    }

    @Test
    public void testListItemSection() {
        test("baz", "{{foo.0.bar}}", context(
                "foo", Arrays.asList(context("bar", "baz"), context("bar", "bif"))));
    }

    @Test
    public void testMapEntriesSection() {
    ...
    @Test
    public void testArrayIndexSection() {
    ...
    @Test
    public void testArrayIndexOutOfBoundsSection() {
    ...
    @Test
    public void testArrayItemSection() {
        test("baz", "{{foo.0.bar}}",
                context("foo", new Object[]{
                        context("bar", "baz"), context("bar", "bif")}));
    }
    ...
    @Test
    public void testIteratorIndexSection() {
        test("baz", "{{#foo.0}}{{bar}}{{/foo.0}}",
                context("foo", Arrays.asList(context("bar", "baz"),
                        context("bar", "bif")).iterator()));
    }
    ...
    @Test
    public void testIteratorIndexOutOfBoundsSection() {
        test("", "{{#foo.2}}{{bar}}{{/foo.2}}",
                context("foo", Arrays.asList(context("bar", "baz"),
                        context("bar", "bif")).iterator()));
    }
    ...
    @Test
    public void testIteratorItemSection() {
        test("baz", "{{foo.0.bar}}",
                context("foo", Arrays.asList(context("bar", "baz"),
                        context("bar", "bif")).iterator()));
    }
    ...
    @Test
    public void testMissingNonStrictSection() {
    ...
    @Test
    public void testCommentWithFunnyChars() {
        test("foobar", "foo{{! {baz\n }}bar", EMPTY);
    }
    ...
    public void testInvalidUnescapeHTML() {
        try {
            ...
            fail();
        } catch (MustacheParseException me) {
        } // expected
    }
    ...
    @Test
    public void testNewlineSkippingCRLF() {
        testNewlineSkipping("\r\n");
    }

    @Test
    public void testNewlineSkippingDelimsTag() {
        test("Begin.\nEnd.\n", "Begin.\n{{=@ @=}}\nEnd.\n", EMPTY);
    }

    @Test
    public void testNoTrimNewlineFromNestedTagAt0() {
        test(" | \n  | \n", " | {{^boolean}}{{! comment }}\n {{/boolean}} | \n",
    ...
    @Test
    public void testCompilingDoesntChangeCompilersDelimiters() {
    ...
    @Test
    public void testInvertibleLambda() {
    ...
    @Test
    public void testLambdaWithContext() {
    ...
    @Test
    public void testLambdaDecompile() {
